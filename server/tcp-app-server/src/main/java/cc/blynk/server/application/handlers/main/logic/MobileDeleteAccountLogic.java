...
public final class MobileDeleteAccountLogic {
     ...
     * Message body should contain the user's password for verification.
     * 
     * @param ctx Channel context
     * @param user The user requesting deletion
     * @param msg Message containing password confirmation
     */
    public void messageReceived(ChannelHandlerContext ctx, User user, StringMessage msg) {
        ...
        // Verify password
        String hashedPassword = SHA256Util.makeHash(password, user.email);
